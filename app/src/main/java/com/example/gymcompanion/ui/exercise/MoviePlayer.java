...
public class MoviePlayer {
    ...
    public void play() throws IOException {
        ...
        try {
            ...
            decoder = MediaCodec.createDecoderByType(Objects.requireNonNull(mime));
    ...
    private static int selectTrack(MediaExtractor extractor) {
        ...
        for (int i = 0; i < numTracks; i++) {
            ...
            String mime = format.getString(MediaFormat.KEY_MIME);
            if (Objects.requireNonNull(mime).startsWith("video/")) {
                if (VERBOSE) {
        ...
        while (!outputDone) {
            ...
            if (!inputDone) {
                ...
                if (inputBufIndex >= 0) {
                    ...
                    int chunkSize = extractor.readSampleData(Objects.requireNonNull(inputBuf), 0);
                    if (chunkSize < 0) {
