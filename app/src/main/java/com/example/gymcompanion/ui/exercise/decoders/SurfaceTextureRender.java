...
public class SurfaceTextureRender {
    ...
    private int TRIANGLE_VERTICES_DATA_STRIDE_BYTES = 5 * FLOAT_SIZE_BYTES;
    private int TRIANGLE_VERTICES_DATA_POS_OFFSET = 0;
    private int TRIANGLE_VERTICES_DATA_UV_OFFSET = 3;
    ...
    private FloatBuffer mTriangleVertices = ByteBuffer.allocateDirect(
    ...
    private int createProgram(String vertexSource, String fragmentSource) {
        ...
        if (program == 0) {
            Log.e("teg", "Could not create program");
        }
