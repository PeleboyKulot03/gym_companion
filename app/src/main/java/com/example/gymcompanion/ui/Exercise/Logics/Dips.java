...
public class Dips {
    ...
    public Dips(TextView counter, TextView timer, Handler timerHandler, LiveFeedPresenter presenter, String exercise, int setNumber, Button finishSet, Activity activity) {
    ...
    public void getTheLandmarks(Pose pose, PoseGraphic poseGraphic, Canvas canvas) {
        ...
        if (((leftWrist != null) && (leftElbow != null) && (leftShoulder != null)) && ((rightWrist != null) && (rightElbow != null) && (rightShoulder != null))) {
            startCounter();
