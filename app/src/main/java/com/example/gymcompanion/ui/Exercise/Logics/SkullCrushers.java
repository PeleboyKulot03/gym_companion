...
public class SkullCrushers {
    ...
    public SkullCrushers(TextView counter, TextView timer, Handler timerHandler, LiveFeedPresenter presenter, String exercise, int setNumber) {
    ...
    public double calculateAccuracy(double angleResult) {
        if (!curLoc.equals("") && (curLoc.equals("MB") || curLoc.equals("BM"))) {
            double accuracy = (100.0 - ((80.0 - angleResult) / 80.0) * 100.0);
            if (accuracy > 100.0) {
